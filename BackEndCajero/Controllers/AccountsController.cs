...
namespace BackEndCajero.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        public AccountsController(BackEndCajeroContext context)
        {
            _context = context;
        }
        ...
        {
            var result = await _context.Account.Include(a => a.Client).ToListAsync();
            return result;
        }
        ...
        {
            account.AccountNo = Guid.NewGuid().ToString();
